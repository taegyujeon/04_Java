...
public class ListService {
	...
	public void method1() {
		...
		for(int i=0 ; i<list.size() ; i++) {
			...
			Object[] test = new Object[5]; //다형성 (업스케팅)
			test[0] ="아무거나";
			test[1] =123123;
			test[2] =new Object();
			test[3] =3.123123;
	...
	public void bookManage() {
		...
		do {
			...
			case 4: // index를 정상적으로 입력했다고 가정
				...
				System.out.print("수정 할 인덱스 번호 : ");
				index = sc.nextInt();
				sc.nextLine(); //버퍼 개행문자 제거
				
				System.out.print("수정 할 책 제목 : ");
				title = sc.nextLine();
				
				System.out.print("수정 할 책 글쓴이 : ");
				writer = sc.nextLine();
				
				System.out.print("수정 할 책 가격 : ");
				price = sc.nextInt();
				
				Book after = new Book(title,writer,price); // 새 책
				Book before = bookList.set(index, after); // 책 바꾸고 이전 책
